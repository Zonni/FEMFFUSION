/**
 * @file   matrix_operators_noise_spn.h
 * @brief  Class to handle complex block matrices.
 */

#ifndef MATFREE_OPERATORS_NOISE_SPN_H_
#define MATFREE_OPERATORS_NOISE_SPN_H_
...
template <int dim, int n_fe_degree>
  class NoiseAMatrixSPN : public TransportMatrixComplexBase<dim, n_fe_degree>
  {
    public:
    ...
    std::vector<std::vector<std::vector<std::vector<Vector<double> > > > > coeffs_real;
    std::vector<std::vector<std::vector<std::vector<Vector<double> > > > > coeffs_imag;

    std::vector<std::vector<std::vector<std::vector<Vector<double> > > > > coeffs_grad;
    std::vector<std::vector<std::vector<std::vector<Vector<double> > > > > coeffs_val;
    std::vector<std::vector<std::vector<std::vector<Vector<double> > > > > coeffs_bound;
 ...
 */
template <int dim, int n_fe_degree>
  class NoiseBMatrixSPN : public MassMatrixComplexBase<dim, n_fe_degree>
  {
    public:
...
#endif /* MATFREE_OPERATORS_NOISE_SPN_H_ */
