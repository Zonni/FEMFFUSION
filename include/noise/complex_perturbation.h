...
class ComplexPerturbation
{
   ...
   * @brief
   */
  std::complex<double> get_delta_sigma_f (const unsigned int group,
   ...
   * @brief
   */
  std::complex<double> get_delta_sigma_r (const unsigned int group,
    const unsigned int mat) const;

  /**
   *
   */
  std::complex<double> get_delta_sigma_s (const unsigned int groupi,
