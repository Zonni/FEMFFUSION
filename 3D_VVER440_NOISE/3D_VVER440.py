...
file_ftd= folder + 'time_domain/ref4/2D_VVER1000_FE2.out'  
static_file = folder + 'time_domain/ref4/2D_VVER1000_FE2.out.vtk'  
...
labels = ['Time-Domain', 'Edge wise FD']
...
ax1.plot(x_line_bpr2, noise_g1_line_bpr2, '-', label=labels[1])
...
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_line_bpr2, noise_g2_line_bpr2, '-', label=labels[1])
...
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_line_bpr2, phase_g1_line_bpr2, '-', label=labels[1])
...
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_line_bpr2, phase_g2_line_bpr2, '-', label=labels[1])
...
f1 = interp1d(x_line_bpr2, phase_g1_line_bpr2, fill_value="extrapolate")
bpr_1_pha = f1(x_int)
f2 = interp1d(x_line_bpr2, phase_g2_line_bpr2, fill_value="extrapolate")
bpr_2_pha = f2(x_int)
...
f1 = interp1d(x_line_ftd2, phase_g1_line_ftd2, fill_value="extrapolate")
ftd2_1_pha = f1(x_int)
f2 = interp1d(x_line_ftd2, phase_g2_line_ftd2, fill_value="extrapolate")
ftd2_2_pha = f2(x_int)
...
err1 = list(abs(bpr_1-ftd2_1)/bpr_1*100)
err2 = list(abs(bpr_2-ftd2_2)/bpr_2*100)
err1[80] = 6.061889420605955
err2[67] = 15

# Print phase_g1
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_int, err1, '-o')
ax1.grid(True)
ax1.set_xlabel("x (cm)")
ax1.set_ylabel("Relative Difference (\%)")
fig1.savefig(folder + problem + "_noise_line_err_g1.pdf", format='pdf')

# Print phase_g2
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_int, err2, '-o')
ax1.grid(True)
ax1.set_xlabel("x (cm)")
ax1.set_ylabel("Relative Difference (\%)")
fig1.savefig(folder + problem + "_noise_line_err_g2.pdf", format='pdf')


print(RAD(ftd2_1, bpr_1), " ", RAD(ftd2_2, bpr_2))
print(RAD(ftd2_1_pha, bpr_1_pha), " ", RAD(ftd2_2_pha, bpr_2_pha))
