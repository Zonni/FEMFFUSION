...
//    std::cout<<"block: "<<block<< ", group: "<<group<< ", moment: "<<moment<<std::endl;
...
template <int dim, int n_fe_degree>
  ...
  StaticFullSPN<dim, n_fe_degree>::postprocess ()
  {
    ...
    if (geo_type == "Composed")
    {
      print_in_file(n_refinements_radial, out, "Radial Refinements: ");
      print_in_file(n_refinements_axial, out, "Axial Refinements: ");
    }
    else
      print_in_file(n_refinements, out, "Global Refinements: ");
