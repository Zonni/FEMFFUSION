...
file_1 = folder + '1D_UOX_FA_ex2_sp1.out.vtk'
file_2 = folder + '1D_UOX_FA_ex2_sp3.out.vtk'
file_3 = folder + '1D_UOX_FA_ex2_sp5.out.vtk'
file_4 = folder + '1D_UOX_FA_ex2_sp7.out.vtk'
...
for i in range(n_files):
    ...
    # Relative noise
    noise_g1 = noise_g1 / stati_g1 * 100 /10
    noise_g2 = noise_g2 / stati_g2 * 100 /10 
...
#file_out = folder + '2D_test_ref.out'  
#static_file = folder + '2D_test_ref.out.vtk'  
...
noise_g1_line[0] = np.array(noise_g1_line[0])
noise_g1_line[1] = np.array(noise_g1_line[1])
noise_g1_line[2] = np.array(noise_g1_line[2])

RME_g1 = max(abs(noise_g1_line[0] - noise_g1_line[2] ) / noise_g1_line[2]  *100);
RAE_g1 = np.mean(abs(noise_g1_line[0] - noise_g1_line[2] ) / noise_g1_line[2]  *100);
print(RME_g1)
print(RAE_g1)

RME_g1 = max(abs(noise_g1_line[1] - noise_g1_line[2] ) / noise_g1_line[2]  *100);
RAE_g1 = np.mean(abs(noise_g1_line[1] - noise_g1_line[2] ) / noise_g1_line[2]  *100);
print(RME_g1)
print(RAE_g1)

noise_g2_line[0] = np.array(noise_g2_line[0])
noise_g2_line[1] = np.array(noise_g2_line[1])
noise_g2_line[2] = np.array(noise_g2_line[2])
RME_g2 = max(abs(noise_g2_line[0] - noise_g2_line[2] ) / noise_g2_line[2]  *100);
RAE_g2 = np.mean(abs(noise_g2_line[0] - noise_g2_line[2] ) / noise_g2_line[2]  *100);
print(RME_g2)
print(RAE_g2)



RME_g2 = max(abs(noise_g2_line[1] - noise_g2_line[2] ) / noise_g2_line[2]  *100);
RAE_g2 = np.mean(abs(noise_g2_line[1] - noise_g2_line[2] ) / noise_g2_line[2]  *100);
print(RME_g2)
print(RAE_g2)
