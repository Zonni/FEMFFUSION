...
fig1 = plt.figure()
ax1 = fig1.add_subplot(1, 1, 1)
ax1.plot(x_lines[2], lines_g2[2], '-', marker=markers[2], c=color[2], label=labels[2])
ax1.plot(x_lines[6], lines_g2[6], '-', marker=markers[6], c=color[6], label=labels[6])
ax1.plot(x_ref, norm_g2 * fluxref_g2, '-',  c=color[7], label='OpenMOC')
ax1.set_xlabel("x (cm)")
ax1.set_ylabel("Scalar Thermal Flux (AU)")
ax1.grid(True)
...
ax1.grid(True)
ax1.legend(loc='upper center')
ax1.set_xlim(13.5, 17)
ax1.set_ylim(81, 87)
fig1.savefig(problem + "SP3_g1z.pdf", format='pdf')
...
ax1.set_xlim(13.5, 17)
ax1.set_ylim(81, 87)
fig1.savefig(problem + "SP5_g1z.pdf", format='pdf')
...
ax1.set_xlim(13.5, 17)
ax1.set_ylim(81, 87)
fig1.savefig(problem + "SP7_g1z.pdf", format='pdf')
