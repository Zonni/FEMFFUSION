...
n_snaps=(5 10 15 20 25 30 40  50 60 70 80 90 100)
...
for ns in "${n_snaps[@]}"; do
    out_file="3D_VVER440_static_rom/POD_n_snapshots_FE2/3D_VVER440_POD${ns}_group_wise.out"
    log_file="./3D_VVER440_static_rom/POD_n_snapshots_FE2/3D_VVER440_POD${ns}_group_wise.log"
