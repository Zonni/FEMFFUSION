...
file = '../2D_VVER1000_vibration/2D_VVER1000.out.vtk'
problem = '../2D_VVER1000_vibration/2D_VVER1000'
#cmap="viridis" 
#cmap="inferno"
cmap="viridis"
...
ax1.xaxis.set_label_position('top') 
fig1.tight_layout()
fig1.savefig(problem + "_staticvtk_g2.png", format='png',dpi=600)
...
ax1.set_aspect('equal')
cbar=fig1.colorbar(cntr2, ax=ax1)
...
ax1.xaxis.set_label_position('top') 
fig1.tight_layout()
fig1.savefig(problem + "_noisevtk_g2_amp.png", format='png',dpi=600)
...
cbar=fig1.colorbar(cntr2, ax=ax1)
cbar.set_label('deg', rotation=90)
ax1.set_aspect('equal')
ax1.set_ylabel("y (cm)")
ax1.set_xlabel("x (cm)")
ax1.invert_yaxis()
...
ax1.xaxis.set_ticks_position('top') # the rest is the same
ax1.xaxis.set_label_position('top') 
fig1.savefig(problem + "_noisevtk_g2_phase.png", format='png', dpi=600)
