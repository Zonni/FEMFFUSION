...
class Materials
{
   ...
   *
   */
  double get_velocitiy (const unsigned int group) const;
   ...
   *
   */
  void set_velocity (const unsigned int group,
    double vel);

  /**
   *
   */
  void set_lambda_prec (const unsigned int group,
    double lambda);

  /**
   *
   */
  void set_beta_prec (const unsigned int group,
    double beta);
   ...
   *
   */
  double get_velocitiy (const unsigned int mat,
    const unsigned int group) const;

  /**
   *
   */
  double get_delayed_decay_constant (const unsigned int mat,
    const unsigned int precursor) const;

  /**
   *
   */
  double get_delayed_fraction (const unsigned int mat,
    const unsigned int precursor) const;

  /**
   *
   */
  double get_delayed_spectra (const unsigned int mat,
   ...
   *
   */
  double get_prompt_spectra (const unsigned int mat,
    const unsigned int group) const;
   ...
   *
   */
  void set_materials_id (const unsigned int cell_user_index,
   ...
   */
  bool is_fuel (const unsigned int pos_x,
   ...
   */
  bool is_reflector (const unsigned int pos_x,
    const unsigned int pos_y,
   ...
   */
  void set_geometry_matrix (const std::vector<unsigned int> &assem_per_dim,
   ...
   * @return sigma_t
   */
  double get_sigma_t (const unsigned int group,
   ...
   *
   */
  double get_xi_nu_sigma_f (unsigned int from_group,
   ...
   *
   */
  double get_nu_sigma_f (unsigned int group,
    unsigned int mat) const;

  /**
   *
   */
  double get_sigma_f (const unsigned int from_group,
    const unsigned int mat) const;
   ...
   *
   */
  std::vector<double> get_xi_nu_sigma_f (unsigned int from_group,
    unsigned int to_group) const;

  /**
   *
   */
  double get_sigma_s (const unsigned int from_group,
   ...
   *
   */
  double get_sigma_r (unsigned int group,
    unsigned int mat) const;
   ...
   *
   */
  std::vector<double> get_sigma_t (const unsigned int group) const;

  /**
   *
   */
  std::vector<double> get_sigma_s (const unsigned int group_i,
   ...
   */
  void set_sigma_f (const double sigma_f,
   ...
   *
   */
  void set_nu_sigma_f (const double nu_sigma_f,
    const unsigned int group,
    const unsigned int mat);
   ...
   *
   */
  void set_sigma_s (const double set_sigma_s,
   ...
   *
   */
  void set_sigma_r (const double sigma_r,
    unsigned int group,
    unsigned int mat);
   ...
   *
   */
  void set_diffusion_coefficient (const double diff_coeff,
    const unsigned int group,
    const unsigned int mat);
  ...
  void change_mat_value (unsigned int old_material,
    unsigned int new_material);

  /**
   *
   */
  void create_new_mixed_mat (const unsigned int averaged_mat,
    const double frac,
   ...
   *
   */
  void create_new_mixed_mat_toni (const unsigned int new_mat,
    const double frac,
    const unsigned int mat_bar,
    const unsigned int mat_no_bar,
    const unsigned int user_index);
  ...
  void create_new_mixed_mat_flux (const unsigned int new_mat,
    const double frac,
    const unsigned int mat_bar,
    const unsigned int mat_no_bar,
   ...
   *
   */
  void modify_xsec (std::string xsec_type,
    unsigned int mat,
   ...
   *
   */
  void modify_xsec_all (std::string xsec_type,
    unsigned int mat,
   ...
   *
   */
  void modify_xsec_7g (std::string xsec_type,
    double sim_time,
   ...
   *
   */
  void create_new_added_mat (const unsigned int new_mat,
    const double frac,
    double inc_xsec_r,
    const unsigned int mat_no_bar,
    const unsigned int user_index);
   ...
   *
   */
  void add_perturbation_xsec (std::string xsec_type,
    unsigned int mat,
    std::vector<double> &delta_xsec);
   ...
   *
   */
  void remove_perturbation_xsec (std::string xsec_type,
    unsigned int mat,
    std::vector<double> &delta_xsec);
   ...
   *
   */
  void compute_xsec_perturbation (unsigned int ncell,
   ...
   *
   */
  bool exist (const unsigned int idx_x,
   ...
   *
   */
  void compute_diffusions_coefficients ();
  ...
  // Cross Sections
  std::vector<std::vector<double> > sigma_t, nu_sigma_f, sigma_f, chi,
      sigma_r, D; // XS[group][material]
  // Group-to-group assemblies  XS[from_group][to_group][material]
  std::vector<std::vector<std::vector<double> > > sigma_s;

  std::vector<std::vector<double> > init_sigma_t, init_nu_sigma_f,
      init_sigma_f, init_chi, init_sigma_r, init_D;
  // Group-to-group assemblies  XS[from_group][to_group][material]
