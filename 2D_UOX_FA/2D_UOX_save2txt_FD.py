...
#%% ===========================================================================
# SAVE To PAOLO format
np.savetxt(file_fd_sta_g1, static_flux_g1_fem.reshape(ny, nx))
np.savetxt(file_fd_sta_g2, static_flux_g2_fem.reshape(ny, nx))
np.savetxt(file_fd_pha_g1, pha_g1_fem.reshape(ny, nx))
