...
out_files =[
    '../periferal_slow/seaborg_SP1_p10.out',
    '../periferal_slow/seaborg_SP1_p10.out']
...
powers[0] = (powers[0] - 1.0) *  (1.58+random.random()*0.01) + 1.0  
powers[1] = (powers[1] - 1.0) *  1.63 + 1.0
...
np.savetxt('peripheralfast/t.txt', time[0])
