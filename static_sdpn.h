...
#ifndef STATIC_SDPN_H
#define STATIC_SDPN_H
...
template <int dim, int n_fe_degree>
  class StaticSDPN
  {
    ...
    TransportMatrixSDPN<dim, n_fe_degree> L;
    FisionMatrixSDPN<dim, n_fe_degree> M;
